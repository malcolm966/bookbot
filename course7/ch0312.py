...
def word_count_memo(document : str, memos : dict):
    memo_dict = memos.copy()
    if document in memo_dict:
        return memo_dict[document], memo_dict
    memo_dict[document] = word_count(document)
    return memo_dict[document],memo_dict
