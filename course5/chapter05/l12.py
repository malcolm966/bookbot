...
class Dragon(Unit):
    ...
    def breathe_fire(self, x, y, units):
        x_1, y_1, x_2, y_2 = x - self.__fire_range, y - self.__fire_range, x + self.__fire_range, y + self.__fire_range
        in_area_units = []
        for i in units:
            if i.in_area(x_1, y_1, x_2, y_2):
                in_area_units.append(i)
        return in_area_units
